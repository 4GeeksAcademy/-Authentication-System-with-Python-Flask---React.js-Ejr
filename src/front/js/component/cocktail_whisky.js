...
export const Cocktail_Whisky = () => {
	const params = useParams();
	const { store, actions } = useContext(Context);
	const cocktail = store.whisky_cocktail[params.theid];
		...
		<Container className="contenedor">
			<div data-aos="fade-down">
				<article className="text-light text-center textBox">
					<p>
						Hacer buenos combinados no tiene demasiado misterio: la única máxima reside en respetar a
						rajatabla las proporciones, ser cuidadoso en el manejo de copas y hielos y usar destilados de
						cierta calidad.
					</p>
					...
					<div data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
						<article className="p-1 text-light text-center textBox">
							...
							<p>
								...
								{cocktail.strIngredient4}, stir gently and transfer to the fridge where we let it cool
								for an hour before serving and enjoy this wonderful cocktail whenever you want.
							</p>
						</article>
					</div>
				</Col>
