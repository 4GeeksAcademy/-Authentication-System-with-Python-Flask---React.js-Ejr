	...
	return (
		<div className="form-container text-center mb-3 border border-3 rounded">
			<form action="#" id="login-form">
				<h2 className="heading mt-3">Iniciar sesión</h2>
				<div className="left">					
					<input type="email" className="input m-2" placeholder="Email" />					
					<input type="password" className="input m-2" placeholder="Password" />
					<div>
