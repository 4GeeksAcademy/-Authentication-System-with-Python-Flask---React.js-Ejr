  ...
  return (
    <div id="error404-container">
      <svg
        ...
        xmlSpace="preserve"
      >
        <g id="error404-Calque_1">
          <text
            id="error404-XMLID_3_"
            transform="matrix(1.2187 0 0 1 13 75.6393)"
            className="error404-st0 error404-st1"
          >
            4
          </text>
          <text
            id="error404-XMLID_4_"
        ...
        <g id="error404-Calque_2">
          <g>
            <path
              id="error404-XMLID_11_"
		...
		c4.4,4.8,10.8,7.8,17.9,7.8c8.3,0,15.6-4.3,19.9-10.7C119.2,54.5,118.6,54.1,118.1,53.7z"
          ...
          <g id="error404-XMLID_6_">
            <g id="error404-XMLID_18_">
              <circle className="error404-circle" cx="100" cy="41" r="1"></circle>
            </g>
          </g>
          <defs>
            <filter id="error404-blurFilter4" x="-20" y="-20" width="200" height="200">
              <feGaussianBlur in="SourceGraphic" stdDeviation="2" />
            </filter>
          </defs>
          <path
            id="error404-XMLID_5_"
            className="error404-st2"
