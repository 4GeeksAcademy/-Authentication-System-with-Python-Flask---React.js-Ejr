			...
			<div data-aos="zoom-out">
				<article className="text-light textBox">
					<p>
						...
						seas un consumidor de esta espirituosa bebida, pero ¿sabes de qué está hecho el vodka? Se
						produce a través de la fermentación de granos y otras platas ricas en almidón. Normalmente su
						contenido en alcohol se encuentra entre 30 y 50% por volumen. Su sabor, suave y delicado,
						permite tomarlo solo; pero lo más común es combinarlo con otras bebidas no alcohólicas.
					</p>
				</article>
			</div>
			<Row>
