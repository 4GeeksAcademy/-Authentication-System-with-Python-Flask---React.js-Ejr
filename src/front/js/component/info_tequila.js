		...
		<Container className="base_cards">
			<div data-aos="zoom-out">
				<article className="text-light textBox">
					<p>
						Seguramente cuando hablamos de tequila, todos pensamos que se trata de una bebida típica
						mejicana, que ha protagonizado muchas canciones y cuya forma de beberla más clásica es con sal y
						limón. Pero un amante del tequila sabe muchas más cosas, y algunas te esas deliciosas mezclas te
