      ...
      <div class="row row-cols-3 g-4">
        <div class="col">
          <div class="card shadow-sm p-3 mb-5 bg-white rounded">
            <img src="https://placeholder.pics/svg/500x350/DEDEDE/555555/novelas" class="card-img-top" alt="Hollywood Sign on The Hill" />
            <div class="card-body">
              ...
              <a href="#" class="btn btn-dark">Ver categoría</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card shadow-sm p-3 mb-5 bg-white rounded">
            <img src="https://placeholder.pics/svg/500x350/DEDEDE/555555/biograficos" class="card-img-top" alt="Palm Springs Road" />
            <div class="card-body">
              <h5 class="card-title">Biograficos</h5>
              <p class="card-text">
