      ...
      <div className="container mb-5">
        ...
        <div className="row text-align pb-9 text-black mb-4 mt-4">
          <p className="text-black">
            <strong>¿Quienes Somos?</strong> <br/>Dogger es una aplicación que permite a dueños de
          ...
          <p className="text-black">
          <strong>¿Que hacer si tengo problemas técnicos?</strong> <br/>Contactanos a nuestro correo: doggercr@info.com
          </p>
          <p className="text-black">
          <strong>Quiero convertirme en un paseador de perros, ¿que tengo que hacer?:</strong>
          <br/>Tener afinidad hacia los perros, ser responsable y tener toda la
          ...
          <p className="text-black">
            <strong>Quiero que alguien pasee a mi perro, ¿que tengo que hacer?: </strong>
            <br/>Registrarte y seguir los pasos especificados de dicho registro en el
            video introductorio.
          </p>
          <p className="text-black"> <strong></strong>
          <strong>¿Hasta cuantos perros puedo pasear?: </strong><br/>Cuatro... y nos estamos arriesgando
          </p>
          <p className="text-black">
          <strong>Por fuera de lo economico, ¿hay algun otro tipo de incentivo?: </strong><br/>Proximamente conforme vayamos creciendo como aplicacion, esperamos o
          ...
          <p className="text-black">
          <strong>¿Es necesario tener bachillerato completado?: </strong>
          <br/>No. Con que cumplas
          ...
          <p className="text-black"><strong>¿Se le da algun tipo de preferencia a los paseadores?: </strong>
          <br/>Se le dara preferencia a aquellos que asi lo consideren los mismos dueños de
            ...
            puedan hacer destacar de los demas.</p>
        </div>
        <Shape />
      </div>
    </div>
