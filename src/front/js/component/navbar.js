		...
		<nav className="navbar navbar-expand-lg navbar-light custom-navbar">
			<div className="container-fluid">
				...
				<div className="nav-item justify-content-end">
					...
					<Link to="/Book"><button type="button" className="custom-button rounded" style={{ marginRight: '10px', backgroundColor: '#E9C46A', color: '#000', padding: '18px 32px', borderRadius: '6px', boxShadow: '0 6px 0 black' }}><i class="fa-solid fa-cart-shopping">{store.services.length}</i></button></Link>
