...
Revision ID: 43031e2b0e47
Revises: 
Create Date: 2023-06-06 23:25:45.082349
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=120), nullable=False),
    sa.Column('platos', sa.Integer(), nullable=True),
    sa.Column('ubicaciones', sa.String(length=80), nullable=False),
    sa.ForeignKeyConstraint(['platos'], ['platos.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
