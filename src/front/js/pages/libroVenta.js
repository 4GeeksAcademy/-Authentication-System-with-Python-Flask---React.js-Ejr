        ...
        <div>
            <div className="container-fluid">
                ...
                <div className="d-flex justify-content-evenly ">
                    <div className="card shadow-sm p-3 mb-5 bg-white rounded" style={{ width: "300px", height: "400px" }}>
                    ...
                    <div className="card shadow-sm p-3 mb-5 bg-white rounded" style={{ width: "300px", height: "400px" }}>
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text">son otro de los tipos de libros más comunes.</p>
                            <a href="#" className="btn btn-dark">Ver categoría</a>
                        </div>
                    </div>
                </div>
