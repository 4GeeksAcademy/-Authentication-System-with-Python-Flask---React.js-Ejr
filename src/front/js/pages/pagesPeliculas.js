    ...
    <div className="main-container" style={{ minHeight: "100vh", paddingBottom: "10%" }}>
      <div className="text-center">
        ...
        <div className="container" style={{ backgroundColor: "transparent", height: "20%", width: "70%", display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
          <h1 className="card-title" style={{ marginTop: "2%", color: "white", fontFamily: "Work Sans" }}>NOMBRE PELÍCULA {detallePelicula.name}</h1>
          ...
          <p className="text-light" style={{ fontFamily: "Work Sans" }}>{detallePelicula.descripcion} The Orbitians
          ...
          <p className="text-light" style={{ marginBottom: "1%", fontFamily: "Work Sans" }}><i class="fa-solid fa-globe" style={{ color: "#858584", marginRight: "5px" }}></i> Netflix</p>
          <p className="text-light" style={{ marginBottom: "0" }}><i class="fa-solid fa-globe" style={{ color: "#858584", marginRight: "5px" }}></i> HBO max</p>
          <p className="card-text" style={{ marginTop: "2%", marginBottom: "1%", fontFamily: "Work Sans" }}>Tags</p>
