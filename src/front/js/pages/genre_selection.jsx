...
export const GenreSelection = () => {
    ...
    <div className="d-flex flex-column min-vh-100" style={{backgroundColor: "#16171C", color: "#fff"}}>
        <img src={logo} alt="Logo" style={{width: '20%', height: '80px', margin: '10px'}} />
    <div className="container text-center my-auto">
        <div className="row justify-content-center align-items-center">
            ...
            <div className="col-md-4 mb-3">
                <div className="genre-card">
                    <img src={rpg} alt="Acción" style={{width: '30%', height: '70px', objectFit: 'cover'}} />
                    <p>RPG</p>
                </div>
            </div>
            <div className="col-md-4 mb-3">
                <div className="genre-card">
                    <img src={strategy} alt="Acción" style={{width: '30%', height: '70px', objectFit: 'cover'}} />
                    <p>Strategy</p>
                </div>
            </div>
            <div className="col-md-4 mb-3">
    ...
    <footer className="text-center py-3 my-4">
        <button className="btn-prev"><i class="fa-solid fa-arrow-left me-2"></i>Back</button>
