			...
			<footer className="py-5">
				...
				<div className="d-flex justify-content-between py-4 my-4 border-top">
					...
					<ul className="list-unstyled d-flex">
						...
						<li className="ms-3"><a className="link-dark" href="#"><svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-instagram" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
							<path stroke="none" d="M0 0h24v24H0z" fill="none" />
