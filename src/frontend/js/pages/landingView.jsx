...
//--- icons ------------------------------------
//mport { HiOutlinePlus } from "react-icons/hi";
//mport { AiFillInstagram } from "react-icons/ai";
//mport { FaYoutube } from "react-icons/fa";
//mport { FaDiscord } from "react-icons/fa6";
//mport { FaTiktok } from "react-icons/fa6";
//mport { FaTwitter } from "react-icons/fa";
//mport { FaRegCircleCheck } from "react-icons/fa6";
//mport { FaRegClock } from "react-icons/fa6";
//mport { HiOutlineCheck } from "react-icons/hi";
...
const LandingView = () => {
	...
	return (
    <div className="bg-dark w-full h-full p-0 m-0 overflow-auto">
    ...
    {/*--- trusted by ------------------------------------ */}
        ...
        <div id="whyKeqquSection" className=" w-full py-28">
          ...
          <div className="grid grid-cols-3 py-10">
            ...
            <div className="bg-primary-d w-[28rem] h-[18rem] rounded-xl mx-auto p-5">
              <i className="fa fa-solid fa-circle-check text-7xl mx-auto my-[12px]"/>
            ...
            <div className="bg-primary-d w-[28rem] h-[18rem] rounded-xl mx-auto p-5">
              <i className="fa fa-solid fa-clock text-7xl mx-auto my-[12px]"/>
          ...
          <div className="grid lg:grid-cols-3 py-10">
            <div className="bg-primary-d w-[26rem] h-[36rem] rounded-xl mx-auto px-10 pt-10 pb-16 flex flex-col">
              ...
              <div className="w-4/5 mx-auto">
                <div className="flex items-center">
                  <i className="fa fa-solid fa-circle-check text-6xl"/>
            ...
            <div className="bg-primary-d w-[26rem] h-[36rem] rounded-xl mx-auto px-10 pt-10 pb-16 flex flex-col">
              ...
              <div className="w-4/5 mx-auto">
                ...
                <div className="flex items-center">
                  <i className="fa fa-solid fa-circle-check text-accent-n"/>
        ...
        <div id="footerSection" className="bg-dark w-full py-28 text-black">
          <div className="bg-primary-d w-[1360px] px-10 rounded-[3rem] mx-auto py-4 text-white">
            ...
            <div className="flex w-9/12 mx-auto mt-5 mb-8 px-20 justify-between">
              ...
              <div className="flex items-center">
              <i className="fa fa-regular fa-instagram text-xl mx-2"/>
              <i className="fa fa-regular fa-youtube text-xl mx-2"/>
              <i className="fa fa-regular fa-discord text-xl mx-2"/>
              <i className="fa fa-regular fa-tiktok text-xl mx-2"/>
              <i className="fa fa-regular fa-twitter text-xl mx-2"/>
