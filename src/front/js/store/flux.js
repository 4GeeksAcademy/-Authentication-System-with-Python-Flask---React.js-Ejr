  ...
  return {
    ...
    actions: {
      Register: (name, email, password, direccion, telefono) => {
        ...
        fetch(
          "https://3001-alexanderwe-proyectofin-emoegafnki4.ws-us67.gitpod.io/api/registro",
          requestOptions
        )
      ...
      GetValidacion: (token_por_validar) => {
        ...
        fetch(
          "https://3001-alexanderwe-proyectofin-emoegafnki4.ws-us67.gitpod.io/api/validartoken",
          requestOptions
        )
          .then((response) => response.json())
          .then((result) => {
      ...
      Login: (email, password) => {
        ...
        fetch(
          "https://3001-alexanderwe-proyectofin-emoegafnki4.ws-us67.gitpod.io/api/token",
          requestOptions
        )
          .then((response) => response.json())
          .then((data) => {
      ...
      getComida: (id) => {
        fetch(
          "https://3001-alexanderwe-proyectofin-emoegafnki4.ws-us67.gitpod.io/api/platos" +
            id
        )
          .then((response) => response.json())
          .then((result) => {
      ...
      getRegistro: (id) => {
        fetch(
          "https://3001-alexanderwe-proyectofin-emoegafnki4.ws-us67.gitpod.io/api/usuarios" +
            id
        )
          .then((response) => response.json())
          .then((result) => {
      ...
      getVegetariano: (id) => {
        fetch(
          "https://3001-alexanderwe-proyectofin-emoegafnki4.ws-us67.gitpod.io/api/veget" +
            id
        )
          .then((response) => response.json())
          .then((result) => {
      ...
      getDulce: (id) => {
        fetch(
          "https://3001-alexanderwe-proyectofin-emoegafnki4.ws-us67.gitpod.io/api/dulce" +
            id
        )
          .then((response) => response.json())
          .then((result) => {
      ...
      getVip: (id) => {
        fetch(
          "https://3001-alexanderwe-proyectofin-emoegafnki4.ws-us67.gitpod.io/api/vip" +
            id
        )
          .then((response) => response.json())
          .then((result) => {
      ...
      getMessage: async () => {
        try {
          ...
          const resp = await fetch(
            "https://3001-alexanderwe-proyectofin-emoegafnki4.ws-us67.gitpod.io/api/hello"
          );
