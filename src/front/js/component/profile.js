...
export const Profile = () => {
    ...
    const fieldActionMap = {
        inputUsername: "displayName",
        inputFirstName: "firstName",
        inputLastName: "secondName",
        inputLocation: "address",
        inputLocationDetails: "addressDetail",
    ...
    const handleInputChange = (e) => {
        ...
        const payloadKey = fieldActionMap[e.target.id || e.target.name];

        if (payloadKey) {
            actions.updateUserProfile({ [payloadKey]: newValue })
        }
    };
                                        ...
                                        <form>
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <input className="form-control" id="inputUsername" type="text" placeholder="Tu Usuario"
                                                    value={item.displayName} onChange={handleInputChange}></input>
                                            </div>
                                            {/* Form Row */}
