...
class User(db.Model):
    ...
    discord_id = db.Column(db.String(80),unique=False,nullable=False)
    steam_id = db.Column(db.String(80),unique=False,nullable=False)
    schedule = db.Column(Enum(Schedule),nullable=False)
