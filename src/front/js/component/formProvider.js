							...
							{store.providers.map((item, i) => {
								return (
									<tr key={i}>
										...
										<td>{store.providers[i].properties[i].email_Provider_Details}</td>
										<td>{store.providers[i].properties[i].payment_Type_Provider_Details}</td>
										<td>{store.providers[i].properties[i].phone_Provider_Details}</td>
										<td>
