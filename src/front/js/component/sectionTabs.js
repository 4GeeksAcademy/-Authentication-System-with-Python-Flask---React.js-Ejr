				...
				<div className="w-max">
					<nav className="-mb-px flex gap-6" aria-label="Tabs">
						<a
							...
							className={`shrink-0 border-b-2 px-1 pb-4 text-sm font-medium transition-all ${activeTab === 'Settings'
						...
						<a
							...
							className={`shrink-0 border-b-2 px-1 pb-4 text-sm font-medium transition-all ${activeTab === 'Messages'
								? 'border-emerald-500 text-neutral-200'
								: 'border-transparent text-emerald-500 hover:border-emerald-300 hover:text-emerald-700'
								}`}
						>
						...
						<a
							...
							className={`shrink-0 border-b-2 px-1 pb-4 text-sm font-medium transition-all ${activeTab === 'Archive'
								? 'border-emerald-500 text-neutral-200'
								: 'border-transparent text-emerald-500 hover:border-emerald-300 hover:text-emerald-700'
								}`}
						>
						...
						<a
							...
							className={`shrink-0 border-b-2 px-1 pb-4 text-sm font-medium transition-all ${activeTab === 'Notifications'
								? 'border-emerald-500 text-neutral-200'
								: 'border-transparent text-emerald-500 hover:border-emerald-300 hover:text-emerald-700'
								}`}
						>
