    ...
    return(
        <div className="container-fluid p-0">
            ...
            <div className="form-group mb-2">
                <label htmlFor="name" className="form-label m-0 fw-semibold">Nombre:</label>
            ...
            <div className="form-group mb-2">
                <label htmlFor="username" className="form-label m-0 fw-semibold">Apellidos:</label>
            ...
            <div className="form-group mb-2">
                <label htmlFor="email" className="form-label m-0 fw-semibold">Email:</label>
            ...
            <div className="form-group mb-2">
                <label htmlFor="country" className="form-label m-0 fw-semibold">Pais:</label>
            ...
            <div className="form-group mb-2">
                <label htmlFor="password" className="form-label m-0 fw-semibold">Contraseña:</label>
