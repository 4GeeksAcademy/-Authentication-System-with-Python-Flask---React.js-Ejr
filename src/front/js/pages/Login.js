    ...
    <div className="container">
      ...
      <div className="row g-3" >
        ...
        <div className="col-md-4 position-relative">
          ...
          <input type="text" className="form-control" placeholder="Enter your zip code. E.g. 10710" required />
        </div>
        <div className="col-md-6 position-relative">
          <label className="form-label">Adress line 1</label>
          <input type="text" className="form-control" placeholder="Street address, P.O box or military address" required />
        </div>
        <div className="col-md-6 position-relative">
          <label className="form-label">Adress line 2</label>
          <input type="text" className="form-control" placeholder="Building, floor, Apt, Suite, Unit, etc." required />
        </div>
