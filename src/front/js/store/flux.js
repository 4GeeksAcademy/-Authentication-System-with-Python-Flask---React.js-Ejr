	...
	return {
		store: {
			...
			restaurantes: [
				{
					name: "Wok",
					plates: [{plateName: "Ramen", price: "40000", description: "x", image: "", restaurantName: "Wok"}, {plateName: "Onigiri", price: "20000", description: "x", image: "", restaurantName: "Wok"}, {plateName: "Arroz", price: "4000", description: "x", image: "", restaurantName: "Wok"}, {plateName: "Sushi", price: "20000", description: "x", image: "", restaurantName: "Wok"}],
				...
				{
					name: "McDonalds",
					plates: [{plateName: "Hamburguesa", price: "15000", description: "x", image: "", restaurantName: "McDonalds"}, {plateName: "Hamburguesa con queso", price: "19000", description: "x", image: "", restaurantName: "McDonalds"}, {plateName: "Doble libra", price: "20000", description: "x", image: "", restaurantName: "McDonalds"}, {plateName: "Big Mac", price: "25000", description: "x", image: "", restaurantName: "McDonalds"}],
					locations: ["Colombia", "Costa"],
				...
				{
					name: "Kukulkan",
					plates: [{plateName: "Pollo asado", price: "15000",  description: "x", image: "", restaurantName: "Kukulkan"}, {plateName: "Medio pollo asado", price: "8000", description: "x", image: "", restaurantName: "Kukulkan"}, {plateName: "Cuarto de pollo asado", price: "6000", description: "x", image: "", restaurantName: "Kukulkan"}, {plateName: "Tortillas", price: "4000", description: "x", image: "", restaurantName: "Kukulkan"}],
					locations: ["Colombia", "Costa"],
				...
				{
					name: "Don Pacino",
					plates: [{plateName: "Tarta de peces", price: "5000", description: "x", image: "", restaurantName: "Don Pacino"}, {plateName: "Pasta destazada", price: "14000", description: "x", image: "", restaurantName: "Don Pacino"}, {plateName: "Puñalini Alfredo", price: "13000", description: "x", image: "", restaurantName: "Don Pacino"}, {plateName: "Pastel de arandanitos", price: "20000", description: "x", image: "", restaurantName: "Don Pacino"}],
					locations: ["Colombia", "Costa"],
