    ...
    return (
        <>
            ...
            {store.allWeeklyRoutineUserList && store.allWeeklyRoutineUserList.length > 0 ? (
                <div className="w-11/12 md:w-3/4 min-h-[60vh] mx-auto flex rounded-md flex-col items-center gap-4 p-1 md:py-5 md:px-5 bg-neutral-800 border-neutral-700 relative">
