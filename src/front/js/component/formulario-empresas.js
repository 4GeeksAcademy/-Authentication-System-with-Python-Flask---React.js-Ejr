        ...
        <div className="container-fluid pt-5">
            ...
            <div className="container row d-flex justify-content-center text-end mx-auto mb-3">
                <div className="col">
                    ...
                    <div class="mb-3 row">
                        <label for="categoria" class="col-sm-3 col-form-label">Sector</label>
                        <div class="col-sm-9">
                ...
                <div className="col">
                    ...
                    <div class="mb-3 row">
                        <label for="ig-user" class="col-sm-6 col-form-label">Razón social</label>
                        <div class="col-sm-6">
            ...
            <div className="container-fluid row text-center mx-0 py-3">
                <div class="mb-3 col-8 mx-auto">
                    <label for="profile-bio" class="form-label">Cuéntanos un poco más de ti</label>
