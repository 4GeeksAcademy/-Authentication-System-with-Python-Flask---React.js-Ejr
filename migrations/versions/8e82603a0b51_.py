...
Revision ID: 8e82603a0b51
Revises: 
Create Date: 2022-08-30 15:40:10.403921
...
def upgrade():
    ...
    sa.Column('latitud', sa.String(length=80), nullable=False),
    sa.Column('longitud', sa.String(length=80), nullable=False),
