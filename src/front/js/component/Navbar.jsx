		...
		<nav className="navbar navbar-dark bg-black ">
			<div className="container-fluid">
				<Link className="navbar-brand" to="/">
					<img style={{ width: "100px", objectFit: "", border: "none" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5Kwl4gT7z8mc8Ug0BaVPrzvedTvuLAZ8VFQ&usqp=CAU</img" alt="logo" />
				</Link>
						...
						<ul className="navbar-nav me-auto text-end mb-2 mb-lg-0 ">
							{!isLoggedIn ? (<><li className="nav-item">
								...
								<li className="nav-item">
									...
									<span className="nav-link text-white" onClick={handleLogout} style={{ cursor: 'pointer' }}>LOGOUT</span>
								</li><li className="nav-item">
							...
							{store.user.isAdmin && (
								<li className="nav-item">
									<Link className="nav-link text-white" to="/admin">EDIT USERS</Link>
								</li>)}
						</ul>

					</div>
					<button style={{ color: "black", border: "none", alignSelf: 'start' }} className="navbar-toggler pt-2" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
