...
class User(db.Model):
    ...
    is_renter = db.Column(db.Boolean, nullable=False)
...
class Canchas(db.Model):
    ...
    rentas = db.relationship('Rentas', secondary=canchas_rentas, back_populates='canchas')
...
class Rentas(db.Model):
    ...
    users = db.relationship('User', secondary=rentas_user, back_populates='rentas')
    canchas = db.relationship('Canchas', secondary=canchas_rentas, back_populates='rentas')
