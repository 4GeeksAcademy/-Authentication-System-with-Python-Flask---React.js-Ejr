				...
				<div className="row p-5 text-white">
					...
					<div className="col-12 col-md-6 col-lg-4">
						...
						<div className="ml-auto">
								<button className="btn btn-outline rounded-pill px-5 text-white" data-bs-toggle="modal" data-bs-target="#contactModal">Rellenar fomulario</button>
						</div>
						<ContactModal/>
						<br />
						<div type="button" className="btn btn-success rounded-pill px-5 text-white phone"> + 34  666 555 444 </div>
					</div>
