    ...
    return store.user ? (
        <>
            ...
            <div className="m-auto mb-4">
                    <img className="avatar_image" src="https://appsdejoseluis.com/wp-content/uploads/2020/04/face_co.png" alt="Avatar" />
                </div>

                <div className="profile_info ">
                    <div className=" row_profile_configuration">
                        <h4 className=" text-wrap badge label col-sm-6 col-md-5 col-lg-3">Nombre y apellidos:</h4>
                        <h4 className=" user_data">{store.user.full_name}</h4>
                    </div>
                    <div className=" row_profile_configuration">
                        <h4 className="text-wrap badge label col-sm-6 col-md-5 col-lg-3">Email:</h4>
                        <h4 className="col-8 user_data">{store.user.email}</h4>
                    </div>
                    <div className=" row_profile_configuration">
                        <h4 className="text-wrap badge label col-sm-6 col-md-5 col-lg-3">Tipo de documento:</h4>
                        <h4 className=" user_data">{store.user.document_type}</h4>
                    </div>
                    <div className=" row_profile_configuration">
                        <h4 className="text-wrap badge label col-sm-6  col-md-5 col-lg-3">Nº del documento:</h4>
                        <h4 className=" user_data">{store.user.document_number}</h4>
                    </div>
                    <div className=" row_profile_configuration">
                        <h4 className="text-wrap badge label col-sm-6 col-md-5 col-lg-3">Teléfono:</h4>
                        <h4 className=" user_data">{store.user.phone}</h4>
                    </div>
                    <div className=" row_profile_configuration">
                        <h4 className="text-wrap badge label col-sm-6 col-md-5 col-lg-3 col-xs-8">Dirección:</h4>
                        <h4 className=" user_data">{store.user.address}</h4>
                    </div>
                    <div className=" row_edit_profile">
