        ...
        <div>
            <div className="container-fluid">
                ...
                <div className="d-flex justify-content-between mb-5">
                    <div className="border border-warning bg-dark text-light d-flex justify-content-center align-items-center" style="width: 200px; height: 200px; border-radius: 50%;">
                    ...
                    </div><div className=" border border-warning bg-dark text-light d-flex justify-content-center align-items-center" style="width: 200px; height: 200px; border-radius: 50%;">
