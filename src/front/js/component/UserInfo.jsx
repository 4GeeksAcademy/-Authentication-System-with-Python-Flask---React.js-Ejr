...
const UserInfo = ({ user, company, showEditButton }) => {
  return (
    ...
    <div className="container text-center my-2" id="profile-worker">
      <div className="row">
        ...
        <div className="col-lg-7">
          ...
          <div className="iconos my-1"> {company.address}</div>
          <div className="iconos my-1"> {company.city}</div>
          <div className="iconos my-1"> {company.cp}</div>
          <div className="iconos my-1"> {company.cif}</div>
        </div>
        {showEditButton && (
