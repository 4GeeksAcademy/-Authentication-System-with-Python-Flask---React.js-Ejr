                    ...
                    <form className="file-upload">
                        <div className="row mb-5 gx-5">
                            <div className="col-xxl-8 mb-5 mb-xxl-0">
                                <div className="bg-secondary-soft px-4 py-5 rounded">
                                    <div className="row g-3">
                                        <h4 className="mb-4 mt-0">Detalles de Casino</h4>
                                        <div className="col-md-6">
                                            <label className="form-label">Nombre Fantasia *</label>
                                            <input type="text" className="form-control" placeholder="" aria-label="First name" value="Sodexo"/>
                                        </div>
                                        <div className="col-md-6">
                                            <label className="form-label">Razon Social *</label>
                                            <input type="text" className="form-control" placeholder="" aria-label="Last name" value="Sodexo SPA"/>
                                        </div>

                                        <div className="col-md-6">
                                            <label className="form-label">RUT *</label>
                                            <input type="text" className="form-control" placeholder="" aria-label="Phone number" value="76.777.777.-7"/>
                                        </div>
                            ...
                            <div className="col-xxl-4">
                                <div className="bg-secondary-soft px-4 py-5 rounded">
                                    <div className="row g-3">
                                        <h4 className="mb-4 mt-0">Logo Casino</h4>
                        ...
                        <div className="gap-3 d-md-flex justify-content-md-end text-center">
                            <button type="button" className="btn btn-danger btn-lg">Eliminar Perfil Casino</button>
                            <button type="button" className="btn btn-primary btn-lg">Actualizar Perfil Casino</button>
                        </div>
                    </form> 
                </div>
            </div>
