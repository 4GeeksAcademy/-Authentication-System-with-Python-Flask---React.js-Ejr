                ...
                <div className="col">
                    <div className="mb-3 row">
                        ...
                        <div className="col-sm-6">
                            <input type="text" className="form-control" id="rep-password" />
                        </div>
                    </div>
                    <div className="mb-3 row">
            ...
            <div className="container row d-flex justify-content-center mx-auto my-5 py-3">
                <div className="col-8">
                    ...
                    <div className="d-flex ">
                        <input className="form-control" type="text" placeholder="Pega aquí el enlace a tu post" aria-label="default input example" id="ig-link" /><i className="fas fa-plus m-auto ms-3"></i>
                    </div>
