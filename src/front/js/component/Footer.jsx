        ...
        <div className="container text-center text-md-start mt-5">
          <div className="row mt-3">
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              <p>
                <a href="#!" className="text-reset">Class Reservation</a>
              </p>
              <p>
                <a href="#!" className="text-reset">Notifications</a>
              </p>
              <p>
                <a href="#!" className="text-reset">Routines</a>
              </p>
              <p>
                <a href="#!" className="text-reset">Administrative Tools</a>
              </p>
            </div>
            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              <p>
                <a href="#!" className="text-reset">Calendar</a>
              </p>
              <p>
