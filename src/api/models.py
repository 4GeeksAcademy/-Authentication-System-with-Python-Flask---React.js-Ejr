...
class User(db.Model):
    ...
    profileimg = db.Column(db.String(400), nullable=False,
                           default='rigo-baby.jpg')
...
class BookSwapRequest(db.Model):
    ...
    request_status = db.Column(
        db.Enum('Accepted', 'Pending', 'Rejected', name='request_type'), nullable=False)
