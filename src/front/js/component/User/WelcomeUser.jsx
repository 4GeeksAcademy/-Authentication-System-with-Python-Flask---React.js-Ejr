...
export const WelcomeUser = () => {
    ...
    const payments = store.payment && store.payment.payments ? store.payment.payments : [];
    const courses = store.course && store.course.access_to_courses ? store.course.access_to_courses : [];
