...
export const AboutUs = () => {
    ...
    return (
        ...
        <div id="responsive" className="custom-aboutUs d-flex flex-column align-items-center justify-content-center">
            ...
            <div className=" d-flex align-items-center justify-content-center">
                ...
                <div className="card custom-aboutUs border-0"  >
                    <div className="card-body">
                        <h4 className="card-title" style={{ textAlign: 'center' }}>Mission</h4>
