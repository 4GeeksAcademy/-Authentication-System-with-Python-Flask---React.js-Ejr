...
export const Navbar = () => {
	return (
        ...
        <i className="far fa-user-circle " id="icono"> Iniciar Sesión</i>
      </button>
        ...
        <div className="modal-dialog">
          <div className="modal-content" id="modal-login">
            <div className="modal-header bg bg-primary text-white" >
				<div className="">
              <h3 className="modal-title" id="exampleModalLabel">Iniciar Sesión</h3>
			  </div>
            ...
            <div className="modal-body" id="Login-us">
              <form >
                ...
                <div className="row" style={{ display: "flex", flexDirection: "row", justifyContent: "end" }} >
                  ...
                  <div className="col-5">
                    <button type="button" class="btn btn-outline-warning" style={{ fontSize: "85%" }}  ><a href={"/registrarEmp"}>Registrar Empresa</a>

                    </button>
                  </div>
                  <div className="col-5">
                    <button type="button" class="btn btn-outline-warning " style={{ fontSize: "85%" }} ><a href={"/registrarUs"}>Registrar Influencer</a>
                    </button>
                  </div>
                  <br></br>
                  <br></br>
