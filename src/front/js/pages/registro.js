			...
			<div className="d-flex justify-content-around my-4">
				<div id="imagen-comentario" className="d-flex flex-column align-items-center">
					...
					<div className="d-flex">
						...
						<div className="speech-bubble">Registrate gratis con nosotros y compara entre las mas conocidas casas de cambio del pais y elige la mejor opción para TI</div>
					</div>
				</div>
				<div>
