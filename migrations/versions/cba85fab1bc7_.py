...
Revision ID: cba85fab1bc7
Revises: 
Create Date: 2021-03-11 21:26:38.900543
...
def upgrade():
    ...
    sa.Column('link_youtube', sa.String(length=600), nullable=True),
    sa.Column('sitio_web', sa.String(length=600), nullable=True),
